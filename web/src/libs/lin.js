(function(global, factory) {
        ...
        Object.defineProperty(exports, 'platform', {
            get: function() {
                ...
                if (window.AndroidInterface !== undefined) {
                    _platform = "android";
                } else if (window.IOSBridge !== undefined) {
                    _platform = "ios";
                } else {
                    _platform = "web";
                }
    ...
    (function(exports) {
        ...
        exports.apply(exports, {
            ...
            name: exports.sandboxName || 'export',
    ...
    //  BASE64.prototype.unicodeChr = function(){
    ...
    //  BASE64.prototype.ansicodeChr = function(){
    ...
    //  BASE64.prototype.unicodeToAnsi = function(chrCode)
    // {
    ...
    //  BASE64.prototype.ansiToUnicode = function(chrCode)
    // {
    //         var chrHex=chrCode.toString(16);
    //         chrHex="000"+chrHex.toUpperCase();
    //         chrHex=chrHex.substr(chrHex.length-4);
    ...
    //    return base64.encode(base64.utf16to8(input));
    //    //return base64.encode(base64.strUnicode2Ansi(input));
    //  },
    //  decode64:function(input){
    //    return base64.utf8to16(base64.decode(input));
    //    //return base64.strAnsi2Unicode(base64.decode(input));
    //  }
    //  });
    ...
    (function(exports) {
        ...
        var createNamespaces = function() {
            ...
            for (i = 0, ln = arguments.length; i < ln; i++) {
                parts = parseNamespace(arguments[i]);
    ...
    (function(exports) {
        ...
        exports.addHeader = setDefaultHeaders;
        //解决文件上传的问题
        ...
        var ajaxFun = function(url, config) {
            ...
            params = ajaxParams(params, config.contentType);
            if (config.method.toLowerCase() !== "post" && !params[1]) {
            ...
            for (var header in defaultHeaders) {
                xmlRequest.setRequestHeader(header, defaultHeaders[header]);
            }
                ...
                if (xmlRequest.status < 300) {
                    ...
                    if (config.responseType.toLowerCase() === 'xml') {
                        ...
                        if (config.result != undefined) {
                            config.result.call(config.scope || window, xmlRequest, resultString);
                        }
                    } else {
                        var resultString = xmlRequest.responseText;
                        if (config.result != undefined) {
                            config.result.call(config.scope || window, xmlRequest, resultString);
                        }
                    }
                    ...
                    if (config.fault) {
                        config.fault.call(config.scope || window, xmlRequest);
                    }
                }
            };
        ...
        exports.ajax = ajaxFun;

        var httpCommUrl = "/";

        Object.defineProperty(exports, 'commUrl', {
            get: function() {
                return httpCommUrl;
            },
            set: function(value) {
                ...
                if (value.charAt(value.length - 1) == '/' && value.length > 1) {
                    httpCommUrl = value.substring(0, value.length - 1);
                } else {
                    httpCommUrl = value;
                }
            },
        ...
        var httpUrl = function(url) {
            if (url.charAt(0) == "/") {
                return (httpCommUrl.length == 1 ? "" : httpCommUrl) + url;
            } else {
                return (httpCommUrl.length == 1 ? "" : httpCommUrl) + "/" + url;
            }
        }
        ...
        Object.defineProperty(exports, 'STANDARD_JSON_REQUEST', {
            value: standardJsonHttpRequestHandle,
            writable: false,
            configurable: false
        });
        var communicateFun = function(url, config) {
            ...
            var resultFire = function(){
                if(!resultFun){
                    return;
                }
                if(config.scope){
                    resultFun.apply(config.scope,arguments);
                }else{
                    resultFun.apply(undefined,arguments);
                }
            }

            var faultFire = function(){
                if(!faultFun){
                    return;
                }
                if(config.scope){
                    faultFun.apply(config.scope,arguments);
                }else{
                    faultFun.apply(undefined,arguments);
                }
            }
            config.result = function(request, resp) {
                // console.log(e);
                var r = undefined;
                try {
                    r = JSON.parse(resp);
        ...
        exports.communicate = communicateFun;
    ...
    (function(exports) {
        ...
        var iosExecFunImpl = function(config) {
            var r = JSON.stringify(config.params || '');

            r = window.IOSBridge(config.plugin || '', config.action || '', r || '{}');
            r = JSON.parse(r);
            if (config.result) {
                config.result(r);
            }
        ...
        var iosExecFun = function(config) {
            if (config.async) {
                setTimeout(function() {
                    iosExecFunImpl(config);
                }, 0);
            } else {
                return iosExecFunImpl(config);
            }
        }
    ...
    (function() {
        ...
        if (lin.platform === 'ios') {
            ...
            window.localStorage.removeItem = function(item) {
                lin.web.exec({
                    plugin: 'storage',
                    action: 'removeItem',
                    params: {
            ...
            window.localStorage.setItem = function(item, value) {
                oldSetItem.call(window.localStorage, item, JSON.stringify({
                    value: value
                }));
            }

            var oldSessionGetItem = window.sessionStorage.getItem;
            window.sessionStorage.getItem = function(item) {
                var value = oldSessionGetItem.call(window.sessionStorage, item);
                if (!value) {
                    return value;
                }
                return JSON.parse(value).value;
            }
            var oldSessionSetItem = window.sessionStorage.setItem;
            window.sessionStorage.setItem = function(item, value) {
                oldSessionSetItem.call(window.sessionStorage, item, JSON.stringify({
                    value: value
                }));
            }
        }
